...
CREATE TABLE `User` (
    ...
    `passwordChangeAt` DATETIME(3) NULL,
    `image` VARCHAR(191) NOT NULL DEFAULT 'https://res.cloudinary.com/dw0cormzj/image/upload/v1679430518/Youth%20Welfare/Student/profile_dteqac.jpg',
    `cloudinary_id` VARCHAR(191) NOT NULL DEFAULT 'default',
...
CREATE TABLE `Cart` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `totalCartPrice` DOUBLE NOT NULL,
...
CREATE TABLE `Order` (
    ...
    `paymentMethodType` VARCHAR(191) NOT NULL DEFAULT 'cash',
